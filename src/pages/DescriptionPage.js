        ...
        <ImageBackground
          source={
            typeof item.img === "string"
              ? { uri: item.img }
              : item.img || require("../images/Home.jpg") // Imagem padrão
          }
          style={stylesDescricao.imgCarousel}
          resizeMode="cover"
        />
      </Animated.View>
    );
  ...
  return (
    <View style={stylesDescricao.container}>
      <View style={{ flex: 1 }}>
        ...
        <Animated.FlatList
          ref={flatListRef}
          data={carousel?.filter((item) => item && item.img)}
        ...
        <Animated.View
          style={[
            stylesDescricao.animatedView,
            { transform: [{ translateY: slideUpView }] },
          ]}
        >
          <Svg
          ...
          <View style={stylesDescricao.cardDescricao}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={stylesDescricao.continente}>
                {description.continent}
              </Text>
              <Text style={stylesDescricao.descricao}>
                {description.description}
              </Text>
              <Text style={stylesDescricao.curiosidadesTitle}>
                Curiosidades
              </Text>
              <View style={{ flexDirection: "row", width: "85%", padding: 5 }}>
                <Text style={stylesDescricao.numero}>{description.numero}</Text>
                <Text style={stylesDescricao.curiosidades}>
                  {description.curiosidades1}
                </Text>
              </View>
              <View style={{ flexDirection: "row", width: "85%", padding: 5 }}>
                <Text style={stylesDescricao.numero}>
                  {description.numero2}
                </Text>
                <Text style={stylesDescricao.curiosidades}>
                  {description.curiosidades2}
                </Text>
              </View>
              <View style={{ flexDirection: "row", width: "85%", padding: 5 }}>
                <Text style={stylesDescricao.numero}>
              ...
              <View style={{ flexDirection: "row", width: "85%", padding: 5 }}>
                ...
                <Text style={stylesDescricao.curiosidades}>
                  {description.curiosidades5}
                </Text>
              </View>
              <Text style={stylesDescricao.curiosidadesTitle}>Custo</Text>
              <Text style={stylesDescricao.curiosidades}>
                {description.custo}
              </Text>
            </ScrollView>
        ...
        <Animated.View
          style={[
            stylesDescricao.btnContainer,
            { transform: [{ translateY: slideUpButton }] },
          ]}
        >
          <TouchableOpacity
